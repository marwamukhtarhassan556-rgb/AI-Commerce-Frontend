...
export default function LandingPage() {
  return <div className="landing-page min-h-screen bg-white text-[#0d2342]">
    ...
    <main className="pt-[73px]">
      ...
      <section className="navi-store-story px-5 py-16 md:px-8"><div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-2"><div className="navi-store-story-image"><img src="/auth-store-background.webp" alt="Store owner preparing online orders" /><span><PackageCheck size={16} /> Orders, support and insights in one place</span><i><Sparkles size={15} /></i></div><div><p className="navi-eyebrow"><ShoppingBag size={14} /> Made for real merchants</p><h2>Built around the work that keeps your store moving</h2><p>From answering shoppers to understanding what they need next, Navi connects the day-to-day work of your store with AI that helps you grow.</p><div className="navi-store-story-points"><span><Check size={16} /> Support customers faster</span><span><Check size={16} /> Keep product knowledge current</span><span><Check size={16} /> Turn conversations into growth</span></div></div></div></section>
