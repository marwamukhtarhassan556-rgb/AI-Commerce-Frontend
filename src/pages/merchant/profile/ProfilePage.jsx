...
export default function ProfilePage() {
  ...
  const saveProfile = async (event) => {
    ...
    try {
      ...
      setProfile(updated);
      localStorage.setItem('merchantProfile', JSON.stringify({ firstName: updated.firstName || form.firstName, lastName: updated.lastName || form.lastName, email: updated.email || profile?.email || '' }));
