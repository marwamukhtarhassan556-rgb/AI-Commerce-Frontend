...
import { normalizeRole } from '../../../api/authService';
...
export default function ProfilePage() {
  ...
  const isSuperAdmin = normalizeRole(role) === 'super-admin' || location.pathname.startsWith('/admin');
  ...
  return <div className="mx-auto max-w-5xl space-y-6 p-6">
    ...
    {!isSuperAdmin && <WidgetAccessPanel />}
