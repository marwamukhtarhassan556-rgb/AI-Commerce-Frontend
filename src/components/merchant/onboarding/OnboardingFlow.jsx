...
export default function OnboardingFlow() {
  ...
  const startFreeTrial = async () => {
    ...
    try {
      ...
      localStorage.setItem('trialPlanId', String(selectedPlan.id));
